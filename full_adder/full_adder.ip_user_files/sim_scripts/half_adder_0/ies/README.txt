...
#
# Generated by export_simulation on Sat Oct 31 11:05:22 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './half_adder_0.sh' script.

./half_adder_0.sh -reset_run
...
./half_adder_0.sh -noclean_files

For more information on the script, please type './half_adder_0.sh -help'.
