...
HD_PWD='C:/GitHub/CS31105/vote_3/vote_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vote_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vote_3.tcl
