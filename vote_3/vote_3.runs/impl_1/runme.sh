...
HD_PWD='C:/GitHub/CS31105/vote_3/vote_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vote_3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vote_3.tcl -notrace
